...
public class ZModelConverter_backup {

	private static ZModelConverter_backup instance = null;
	...
	private ZModelConverter_backup() {
	}

	public static ZModelConverter_backup getInstance() {
		if (instance == null) {
			instance = new ZModelConverter_backup();
		}
		return instance;
	}

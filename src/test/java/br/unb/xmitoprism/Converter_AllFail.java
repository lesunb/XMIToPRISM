	...
	public static Collection<Object[]> data() {
		...
		return Arrays.asList(new Object[][] {
									// add new	{ testsFolder + "path"} * don't forget comma! *
												...
												{ testsFolder + "magicdraw_ad_fail_cf-loop.xml" },
												{ testsFolder + "magicdraw_ad_fail_cf-no-prob.xml" },
												{ testsFolder + "magicdraw_ad_fail_mandatory-cf-fn.xml" },
												{ testsFolder + "magicdraw_ad_fail_mandatory-cf-in.xml" },
												{ testsFolder + "magicdraw_ad_fail_mandatory-incoming-cf-en.xml" },
												{ testsFolder + "magicdraw_ad_fail_mandatory-outgoing-cf-dn.xml" },
												{ testsFolder + "magicdraw_ad_fail_mandatory-outgoing-cf-en.xml" },
												{ testsFolder + "magicdraw_ad_fail_mult-cf-from-en.xml" },
												{ testsFolder + "magicdraw_ad_fail_mult-cf-to-en.xml" },
												{ testsFolder + "magicdraw_ad_fail_mult-cf-to-fn.xml" },
												{ testsFolder + "magicdraw_sd_fail_lifeline-no-prob.xml" },
